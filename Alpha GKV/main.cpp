...
GLuint texture_gedung_q1;
GLuint texture_gedung_q2;
GLuint texture_gedung_q3;
GLuint texture_gedung_q4;
...
GLuint createOpenGLTexture(Image* image) {
    ...
    gluBuild2DMipmaps(GL_TEXTURE_2D, internalFormat, image->width, image->height, 
...
void init() {
    ...
    Image* img_gedung_q1 = loadBMP("gedung1.bmp"); 
    if (img_gedung_q1 != NULL) {
        texture_gedung_q1 = createOpenGLTexture(img_gedung_q1);
        delete img_gedung_q1; 
    } else {
        printf("PERINGATAN UTAMA: Gagal memuat gedung1.bmp!\n");
        texture_gedung_q1 = 0;
    }
    
    Image* img_gedung_q2 = loadBMP("gedung2.bmp"); 
    if (img_gedung_q2 != NULL) {
        texture_gedung_q2 = createOpenGLTexture(img_gedung_q2);
        delete img_gedung_q2; 
    } else {
        printf("PERINGATAN UTAMA: Gagal memuat gedung2.bmp!\n");
        texture_gedung_q2 = 0; 
    }

    Image* img_gedung_q3 = loadBMP("gedung3.bmp"); 
    if (img_gedung_q3 != NULL) {
        texture_gedung_q3 = createOpenGLTexture(img_gedung_q3);
        delete img_gedung_q3; 
    } else {
        printf("PERINGATAN UTAMA: Gagal memuat gedung3.bmp!\n");
        texture_gedung_q3 = 0; 
    }

    Image* img_gedung_q4 = loadBMP("gedung4.bmp"); 
    if (img_gedung_q4 != NULL) {
        texture_gedung_q4 = createOpenGLTexture(img_gedung_q4);
        delete img_gedung_q4; 
    } else {
